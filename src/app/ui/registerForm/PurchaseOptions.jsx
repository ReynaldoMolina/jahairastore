  ...
  return (
    <FormOptionContainer>
      <div className="flex gap-1 items-center">
        ...
        <FormOption label="Envío" href={`/gastos/create?compra=${purchase.Id}&proveedor=${purchase.Id_proveedor}&concepto=Envío`}>
          <ShipmentIcon className="size-5" />
        </FormOption>
      </div>
      {purchase.TotalGasto > 0 &&
        <FormOption label="Gastos" href={`/gastos?query=${purchase.Id} ${purchase.Nombre_empresa}`}>
          <ExpensesIcon className="size-5" />
        </FormOption>
      }
    </FormOptionContainer>
