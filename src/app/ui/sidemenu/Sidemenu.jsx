...
export default function SideMenu() {
  return (
    <menu
      className="flex flex-col md:min-h-screen bg-white dark:bg-neutral-700/50 md:shadow-xl rounded-t-xl md:rounded-tl-none md:rounded-r-xl z-1 w-screen md:min-w-55 md:w-55 order-2 md:order-0 overflow-hidden"
    >
