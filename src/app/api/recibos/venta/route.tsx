...
export async function GET(req: NextRequest) {
  ...
  const idVenta = searchParams.get('id_venta') || undefined;

  const register = await getSaleReceiptPdf(idVenta);
      ...
      >
        ...
        <div tw="flex mb-5 text-[20px]">
          ...
          <div tw="flex flex-col">
            <div tw="flex mb-2">
              <span tw="font-bold w-20">Venta:</span> {register.id}
            </div>
            <div tw="flex">
              <span tw="font-bold w-20">Tipo:</span>{' '}
              {register.credito ? 'Crédito' : 'Contado'}
            </div>
          </div>
        </div>
        ...
        <div tw="flex flex-col text-[18px]">
          ...
          <div tw="flex font-bold bg-neutral-100 py-1.5 px-1">
            ...
            <div tw="flex w-27 justify-end">C${formatNumber(generalTotal)}</div>
          </div>
        </div>
        ...
        <div tw="flex flex-col items-end mt-5 text-[20px] ">
          ...
          <div tw="flex">
            ...
            <span tw="flex w-37 justify-end">
              C$
              {register.abono === 0 && register.credito
                ? formatNumber(generalTotal)
